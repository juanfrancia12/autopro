          ...
          <section className="w-full overflow-hidden">
            <div className="container mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                {DATOS_SERVICIOS.map(item => {
                  const { id, image, nombre, descripcion } = item
                  return (
                    <div
                      key={id}
                      className="h-auto md:h-[27rem] rounded-2xl border border-gray-300 overflow-hidden"
                    >
                      <img
                        alt="gallery"
