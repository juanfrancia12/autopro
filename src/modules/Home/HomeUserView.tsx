import GraphicsArea from '@components/templates/graphics/area'
import GraphicsColumn from '@components/templates/graphics/column'
  ...
  return (
    <div className="grid grid-cols-7 gap-5">
      <div className="col-span-4 flex flex-col gap-5">
        ...
        <div className="h-72 p-6 bg-white border border-gray-300 rounded-lg flex flex-col gap-5">
          <div>Compras</div>
      ...
      <div className="col-span-3 flex flex-col gap-5">
        <div className="h-80 p-6 bg-white border border-gray-300 rounded-lg  flex flex-col gap-5">
          <div>Citas</div>
          <div className="h-full">
            <GraphicsColumn />
          </div>
